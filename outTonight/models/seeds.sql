...
INSERT INTO `events` (name, type, date, time, location, description, cost, createdAt, updatedAt) 
    VALUES ("America's Funniest Home Videos", "Television", "2019-03-09", "1300", "ABC Manhattan Beach Studios", "Join the studio audience watching hysterical videos and funny commentary by host Afonso Ribeiro.", "0", now(), now());
